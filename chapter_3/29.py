...
R = S.get(
    ...
    params=PARAMS,
    headers={
        "User-Agent": "NLP100Exercises/1.0" #Wikipedia APIを利用する際には、User-Agentを設定することが推奨されている。ここでは、IchinoseBotという名前のBotを作成し、バージョン1.0であることを示している。また、studentというタグも付けている。
    }
)
