...
#出力
'''
/data/student/i2311021/conda_envs/100-swing-drill-gpu/bin/python -u chapter_10_2020/93_2020ver.p
y
============================================================
BLEUスコアの計測
============================================================
...
翻訳中: 640/1,160文 (10/19バッチ)
翻訳中: 1,160/1,160文 (19/19バッチ)

============================================================
評価結果
============================================================
BLEUスコア: 15.92
詳細       : BLEU = 15.92 42.9/19.9/11.1/6.8 (BP = 1.000 ratio = 1.137 hyp_len = 30187 ref_len = 26560)
...
例 1
日本語: InfoboxBuddhist
正解訳: Infobox Buddhist
生成訳: <unk>

------------------------------------------------------------
例 2
日本語: 道元 （ どう げん ） は 、 鎌倉 時代 初期 の 禅僧 。
正解訳: Dogen was a Zen monk in the early Kamakura period.
生成訳: Dogen was a Zen priest in the early Kamakura period.

------------------------------------------------------------
例 3
日本語: 曹洞宗 の 開祖 。
正解訳: The founder of Soto Zen
生成訳: He was the founder of the Soto sect.

------------------------------------------------------------
例 4
日本語: 晩年 に 希 玄 という 異称 も 用い た 。
正解訳: Later in his life he also went by the name Kigen.
生成訳: In his later years, he was also called <unk>.

------------------------------------------------------------
例 5
日本語: 同 宗旨 で は 高祖 と 尊称 さ れる 。
正解訳: Within the sect he is referred to by the honorary title Koso.
生成訳: In the same religious doctrine, he was called <unk>.
------------------------------------------------------------

評価結果を保存しました。
トークン化生成訳: /data/student/i2311021/projects/100-swing-drill/chapter_10_2020/outputs/93_bleu/test.hypothesis.tokenized.en
デトークナイズ生成訳: /data/student/i2311021/projects/100-swing-drill/chapter_10_2020/outputs/93_bleu/test.hypothesis.detokenized.en
デトークナイズ正解訳: /data/student/i2311021/projects/100-swing-drill/chapter_10_2020/outputs/93_bleu/test.reference.detokenized.en
BLEU評価結果: /data/student/i2311021/projects/100-swing-drill/chapter_10_2020/outputs/93_bleu/bleu_result.txt
(base) i2311021@g00:~/projects/100-swing-drill$ 
'''