...
#出力
'''
/data/student/i2311021/conda_envs/100-swing-drill-gpu/bin/python -u chapter_10_2020/92_2020ver.py
使用デバイス: cuda
...
============================================================
入力文       : 私はこれ以上勉強したくないです
日本語形態素 : 私 は これ 以上 勉強 し たく ない です
英語トークン : I do not want to study more thanthe above .
翻訳結果     : I do not want to study more thanthe above.
============================================================
